...
#define OTA_SERVER_TASK_PRIORITY 1
...
#define OTA_SERVER_TASK_STACK_SIZE 4096
...
void createTasks() {
    ...
    xTaskCreate(
        TaskOTAServer,      // Task function
        "OTAServer",        // Task name
        OTA_SERVER_TASK_STACK_SIZE, // Stack size
        NULL,               // Task parameters
        OTA_SERVER_TASK_PRIORITY, // Priority
        NULL                // Task handle
    );
}
